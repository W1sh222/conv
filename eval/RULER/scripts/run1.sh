...
MODEL_DIR="/inspire/hdd/global_user/gexinmu-253108100065/Resources/models/LLMs" # the path that contains individual model folders from Huggingface.
ENGINE_DIR="." # the path that contains individual engine folders from TensorRT-LLM.
BATCH_SIZE=1  # increase to improve GPU utilization


# Model and Tokenizer
source config_models2.sh
MODEL_NAME=${1}
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --conv_safe_topk)
            ...
            ;;
        --no_conv_use_triton)
            CONV_TRITON="--no_conv_use_triton"
            shift
            ;;
        *)
