#!/usr/bin/env python3
"""Low-memory 24K-32K guarded training for the original sparse Conv kernel.
...
def main() -> None:
    ...
    print("=" * 80)
    print("Sparse guarded long-context training (24K-32K)")
        ...
        while not completed:
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "--layers_per_sample 1, --teacher_head_chunk 2, or "
